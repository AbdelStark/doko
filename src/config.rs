...
pub mod vault {
    ...
    pub const MIN_VAULT_AMOUNT: u64 = 5_000;
...
mod tests {
    ...
    fn test_address_validation() {
        // Valid addresses
        assert!(validation::validate_address_format(
            "tb1p9calmmwcsv8r6fgnxl6wtmhajrpgnvafjdl6wmtmxpyk63s5fj4slke3fs"
        )
        .is_ok());
        assert!(validation::validate_address_format(
            "bc1p885a5n2nhs4vjjf5dcqm70r6p2g0mfmau2vms0y9v39gnk06cwdsqp55gt"
        )
        .is_ok());
